...
const SmoothLoadingOverlay = ({ visible, uploadProgress = 0 }) => {
    ...
    if (visible) {
      ...
      Animated.parallel([
        Animated.timing(fadeAnim, {
          toValue: 1,
          duration: 600, // Slower fade in
          easing: Easing.out(Easing.quad),
          useNativeDriver: false,
        }),
        Animated.timing(slideAnim, {
          toValue: 0,
          duration: 800, // Slower slide up
          easing: Easing.out(Easing.back(1.2)), // Bouncy effect
          useNativeDriver: false,
        }),

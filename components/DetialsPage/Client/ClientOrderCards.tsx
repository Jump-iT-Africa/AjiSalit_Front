...
const EditHistoryModal = ({ visible, onClose }) => {
        ...
        <View className="flex-1 justify-center items-center bg-black/50">
          <View className="w-11/12 bg-white rounded-lg overflow-hidden">
            ...
            <View className="p-4 border-b border-gray-200">
              ...
              <Text className="text-right font-tajawal font-bold text-lg">#HFH83923nsh</Text>
            </View>
            <View className="p-4">
           ...
           <View className="flex-row items-end justify-end space-x-2 p-4 border-b border-gray-100">
                <View className='flex-row-reverse items-center justify-between w-full'>
                    <View className='flex-row items-end justify-end space-x-2'>
                        <View className="flex items-end ">
                            <Text className={`text-lg font-bold text-[#d83ce9] font-tajawal`}>خياط</Text>
                            <Text className="text-black text-sm ">#HFH83923nsh</Text>
                        </View>
                        <View className={`w-11 h-11 rounded bg-[#f290fd] items-center justify-center`}>
                            <FontAwesome5 name="cut" size={20} color="#d83ce9"/>
                        </View>
                    </View>
            ...
            <View className="flex-row justify-between items-center p-3 mt-1 mx-2 bg-gray-100 border border-gray-300 border-1 rounded-lg mb-2">
                ...
                <View className="flex-row items-center">
                    ...
                    <View>
                        <Text className="text-sm text-black mr-2 font-tajawalregular mt-2">10/03/2025</Text>
                        <Text className="text-sm text-gray-400 mr-2 font-tajawalregular line-through">08/03/2025</Text>
                    </View>
